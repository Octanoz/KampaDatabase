 ...
 * Doctors - have a specialization (Surgeon, Cardiologist, etc.)
 * Nurses - have a level (RN, LPN, etc.)
 * Custodian
...
string employeeFilesPath = @"C:\Users\rheye\source\repos\Training\DatabaseChallenge\EmployeeFiles";
